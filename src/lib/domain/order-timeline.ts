...
export function buildOrderTimeline(
  ...
  const releasedStep = released
    ? step(
        ...
        'تم',
        /*
         * «عائدك» كلمةٌ لا يقولها بائع.
         *
         * وهي — على قِصَرها — تُخبر أنّ شيئًا وقع ولا تقول أين استقرّ ولا ما
         * يملك صاحبه أن يفعل به؛ ومن باع لوحته يسأل سؤالًا واحدًا بعدها: كيف
         * أُخرجه؟ فيُقال له في السطر نفسه. واللفظ هو لفظ بطاقة إتمام الصفقة
         * حرفًا بحرف — الصفحة تعرضهما معًا، فاختلافهما يُقرأ حدثين لا حدثًا.
         */
        buyer ? 'ذهب المبلغ إلى البائع' : 'تم اكتمال الصفقة',
        order.releasedAt ?? order.completedAt,
        'done',
        buyer
          ? 'اكتملت الصفقة، واللوحة باسمك'
          : hasFees
            ? 'مبلغ البيع تم إيداعه في محفظتك بعد عمولة المنصّة وضريبتها، ويمكنك سحبه لحسابك البنكي'
      ...
      : closed
        ...
        : disputed
          ...
          : step(
              'released',
              'تحويل',
              buyer ? 'تحويل المبلغ للبائع' : 'إيداع مبلغ البيع في محفظتك',
              null,
              'pending',
              transferred
                ? buyer
