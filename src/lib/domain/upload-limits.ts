...
export const UPLOAD_LIMITS = {
  ...
  /*
   * مئةُ ميغابايت للفدّيو — **وهو سقفُ الذاكرة لا سقفُ القرص**.
   *
   * الرفع يمرّ بالخادم، و`request.formData()` تقرأ الملفّ كلَّه إلى الذاكرة
   * قبل أن يُكتب. فما يُرفع يُحجز مثلُه — ومرّتين في لحظة النسخ. ومئةٌ
   * تكفي مقطعَ ستوري من دقيقةٍ بدقّة 1080p، وتبقى بعيدةً عن حدّ الحاوية.
   *
   * ولو احتيج ما هو أكبر فالعلاجُ بثُّ الجسم إلى القرص بدل قراءته دفعةً —
   * لا رفعُ الرقم، فرفعُه وحده يقتل الحاوية عند أوّل رفعتين متزامنتين.
   */
