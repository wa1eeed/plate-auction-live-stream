  ...
  const faqSeed: Omit<FaqItem, 'id' | 'createdAt' | 'updatedAt'>[] = [
    {
      ...
      answer:
        'السعر الاحتياطي هو أقل مبلغ يقبل البائع البيع عنده. يبقى سرًّا لا يغادر خوادمنا حتى لا يتحوّل المزاد إلى مساومة عليه، فترى بدله «تحقّق» أو «لم يتحقّق» فقط. إذا انتهى المزاد دون بلوغه فلا بيع، وتُفكّ عرابين الجميع.',
      category: 'general',
      sortOrder: 1,
      published: true,
      showOnListing: true,
    ...
    },
    {
      ...
      answer:
        'نعم. الدفع بالبطاقة يتمّ على صفحة بوابة الدفع نفسها، ولا تمرّ بيانات بطاقتك بخوادمنا ولا نحفظ منها شيئًا. نستلم من البوابة نتيجة العملية فقط.',
      category: 'payment',
      sortOrder: 6,
      published: true,
      showOnListing: false,
    ...
    },
    {
      ...
      answer:
        'إن فعّلت الإدارة العمولة فهي تظهر لك **قبل** المزايدة أو الشراء لا بعده، محسوبةً على السعر القائم. تُقتطع من محفظتك لحظة اكتمال الصفقة لا من ثمن اللوحة — فالسداد بينك وبين الطرف الآخر خارج المنصّة. وضريبة القيمة المضافة، إن كانت مفعّلة، تُطبَّق على العمولة وحدها لا على قيمة اللوحة: المنصّة تبيع خدمة وساطة لا تبيع اللوحة.',
      category: 'payment',
      sortOrder: 8,
      published: true,
      showOnListing: true,
