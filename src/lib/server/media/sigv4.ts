...
export function signRequest(input: {
  ...
  /*
   * `x-amz-content-sha256` **ليست هنا** — يضيفها `r2.ts`.
   *
   * وهي شرطٌ في S3 لا في الصيغة. ولو أُضيفت هنا لَما أمكن أن يُقاس هذا
   * الملفّ بمتّجهات أمازون المنشورة أصلًا: متّجه `get-vanilla` يوقّع
   * `host` و`x-amz-date` وحدهما، فترويسةٌ زائدة تُغيّر التوقيع — فيبقى
   * الفحص يقيس شكل النصّ لا صحّة الحساب. وقد بقي كذلك أوّل مرّة.
   */
