...
import { AdminNav, type AdminNavBadges } from './admin-nav'
    ...
    <div data-theme="light" className="relative flex min-h-dvh flex-col bg-ink-950 text-paper">
      ...
      <header className="sticky top-0 z-40 border-b border-ink-600 bg-[#0e1420] text-white">
        <div className="mx-auto flex h-14 w-full max-w-[1400px] items-center gap-3 px-4 sm:px-6">
          ...
          <span className="rounded-full border border-gold-600/50 bg-gold-500/15 px-2.5 py-0.5 text-[11px] font-bold text-gold-400">
            صلاحيات إدارية
          </span>
