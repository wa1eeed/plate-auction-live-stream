 ...
 *
 * لا تُصيَّر أصلًا خارج `APP_ENV=staging`: تُرجع `null` قبل أي عنصر، فلا تترك
 * في نسخ العملاء عقدةً في الشجرة ولا سطرًا في الحُزمة.
 */
export function StagingBanner() {
  ...
  return (
    ...
    >
      ...
      نسخة تجريبية (staging) — البيانات والأرصدة والمزادات كلّها وهمية،
