...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    /*
     * الفافيكون يُرفع، وأيقونةُ الشاشة الرئيسية **لا** — وبينهما عهدان مختلفان.
     *
     * فالفافيكون يجلس في شريط تبويب: يجوز أن يكون شفّافًا وغيرَ مربّع وصغيرًا.
     * وأيقونةُ الشاشة الرئيسية يضع النظامُ عليها قناعًا مستديرًا، فتلزمها
     * مربّعةً معتمةً إلى أطرافها وكبيرة.
     *
     * وكان `apple` يأخذ المرفوع — وسفاري يبني منه أيقونة الشاشة وحدها كما
     * يقول التعليق أدناه. فصارت أيقونةُ التطبيق على الجوّال فافيكونًا: قِيست
     * المرفوعة فكانت ٣٠١×٣٠١ وزواياها `rgb(237,246,244)`، بينما `app-icon.png`
     * المصمَّمة لهذا ٥١٢×٥١٢ وزواياها `rgb(3,46,24)`. فظهرت زوايا بيضاء داخل
     * استدارة القناع — وهي العلّة التي قِيست وأُصلحت في الملفّ ثمّ لم تُستعمل.
     *
     * ولا يُخشى على التثبيت من نسخةٍ لم تُرفع لها هويّة: `app-icon.png` في
     * `public/` دائمًا، فالأيقونة حاضرةٌ رُفع شعارٌ أو لم يُرفع.
     */
    icons: {
