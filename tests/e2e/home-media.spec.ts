...
test.describe('سياسة المحتوى', () => {
  test('`media-src` مذكورةٌ صراحةً — وبلاها لا يُشغَّل فدّيو الستوري', async ({ page }) => {
    ...
    /*
     * وبلا نطاقٍ مضبوط تبقى السياسة على ضيقها: لا `https:` مفتوحة.
     *
     * فمن ضبط `R2_PUBLIC_BASE_URL` يُضاف **أصلُه وحده**، ومن لم يضبطه لا
     * يُفتح له باب — والمجموعة تعمل على القرص فلا نطاق فيها.
     */
