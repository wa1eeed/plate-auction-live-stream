...
# --------------------------------------------------------------
#  سقفٌ للكومة، وعاملٌ واحد — لخادمٍ صغير يبني فوق ما يشغّله.
#
#  عقدةٌ بلا سقف تنمو حتى تلتهم ما تجده، فيقتلها نظام التشغيل. والقتل لا
#  يُطبع: يظهر `ELIFECYCLE Command failed.` **بلا رمز خروج** وبلا سطر خطأ،
#  فيُظنّ العطبُ في الكود وهو في الذاكرة. وقد وقع ذلك فعلًا حين أُضيف
#  `middleware.ts` — وهو هدفُ ترجمةٍ إضافيّ لبيئة الحافّة.
#
#  وبالسقف تجمع عقدةُ القمامة بدل أن تنمو، فتبني أبطأ ولا تُقتل. وعاملٌ
#  واحد يمنع Next من فتح عمليةٍ لكلّ نواة على خادمٍ نواتُه كثيرة وذاكرتُه
#  قليلة.
#
#  وليس هذا بديلًا عن ذاكرة كافية أو ملفّ مبادلة — هو ما يجعل الضيق يُبطئ
#  بدل أن يُسقط.
# --------------------------------------------------------------
